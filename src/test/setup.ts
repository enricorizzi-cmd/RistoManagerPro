// This file must be loaded BEFORE any modules that use URL/URLSearchParams
// Mock URL and URLSearchParams at the global level to avoid webidl-conversions errors
