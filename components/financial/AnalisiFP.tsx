  ...
  const analysisData = useMemo(() => {
    ...
    availableYears.forEach(year => {
      for (let monthIndex = 0; monthIndex < 12; monthIndex += 1) {
        ...
        const saldoSecondoConto = getFieldValue(
          dataWithKey,
          'saldoSecondoConto'
        );
    ...
    const currentMonthData = selectedMonth
      ? allData.find(
          d =>
            ...
            d.monthIndex === selectedMonth.monthIndex
        ) || lastCompiledMonth
      : lastCompiledMonth;
    ...
    const getSameMonthPreviousYear = (field: keyof typeof currentMonthData) => {
      const prevYearData = allData.find(
        d => d.year === currentYear - 1 && d.monthIndex === currentMonth
      );
    ...
    const getLast12MonthsValues = (field: keyof typeof currentMonthData) => {
      const last12Months = allData
        .filter(d => {
          ...
          const diffMonths =
            (currentDate.getFullYear() - dDate.getFullYear()) * 12 +
            (currentDate.getMonth() - dDate.getMonth());
    ...
    indicators.push({
      ...
      lastMonth: fatturatoLastMonth
        ? calculatePercentageChange(
            currentMonthData.fatturatoTotale ?? 0,
            fatturatoLastMonth as number
          )
        : null,
      ytdValues: {
        currentValue: fatturatoYTD.currentYTD,
        previousValue: fatturatoYTD.previousYTD,
      },
      ytd: fatturatoYTD.previousYTD
        ? calculatePercentageChange(
            fatturatoYTD.currentYTD,
            fatturatoYTD.previousYTD
          )
        : null,
      last12MonthsValues: {
        currentValue: fatturato12Months.last12Months,
        previousValue: fatturato12Months.previous12Months,
      },
      last12Months: fatturato12Months.previous12Months
        ? calculatePercentageChange(
            fatturato12Months.last12Months,
            fatturato12Months.previous12Months
          )
        : null,
      unit: '%',
    });
    ...
    indicators.push({
      ...
      lastMonth: incassatoLastMonth
        ? calculatePercentageChange(
            currentMonthData.incassato ?? 0,
            incassatoLastMonth as number
          )
        : null,
      ytdValues: {
        currentValue: incassatoYTD.currentYTD,
        previousValue: incassatoYTD.previousYTD,
      },
      ytd: incassatoYTD.previousYTD
        ? calculatePercentageChange(
            incassatoYTD.currentYTD,
            incassatoYTD.previousYTD
          )
        : null,
      last12MonthsValues: {
        currentValue: incassato12Months.last12Months,
        previousValue: incassato12Months.previous12Months,
      },
      last12Months: incassato12Months.previous12Months
        ? calculatePercentageChange(
            incassato12Months.last12Months,
            incassato12Months.previous12Months
          )
        : null,
      unit: '%',
    });
    ...
    indicators.push({
      ...
      lastMonth: saldoCCLastMonth
        ? calculatePercentageChange(
            currentMonthData.saldoTotale ?? 0,
            saldoCCLastMonth as number
          )
        : null,
      ytdValues: saldoCCYTDValues,
      ytd: saldoCCYTDPreviousAvg
        ? calculatePercentageChange(saldoCCYTDCurrentAvg, saldoCCYTDPreviousAvg)
        : null,
      last12MonthsValues: saldoCC12MonthsValues,
      last12Months: saldoCC12MonthsPreviousAvg
        ? calculatePercentageChange(
            saldoCC12MonthsCurrentAvg,
            saldoCC12MonthsPreviousAvg
          )
        : null,
      unit: '%',
    });
    ...
    // CREDITI PENDENTI
    const creditiPendentiLastMonth =
      getSameMonthPreviousYear('creditiPendenti');
    const creditiPendentiYTD = getYTDValues('creditiPendenti');
    const creditiPendenti12Months = getLast12MonthsValues('creditiPendenti');

    const creditiPendentiYTDCurrentAvg =
      creditiPendentiYTD.currentYTD / (currentMonth + 1);
    const creditiPendentiYTDPreviousAvg =
      creditiPendentiYTD.previousYTD / (currentMonth + 1);
    const creditiPendenti12MonthsCurrentAvg =
      creditiPendenti12Months.last12Months / 12;
    const creditiPendenti12MonthsPreviousAvg =
      creditiPendenti12Months.previous12Months / 12;
    ...
    const creditiPendenti12MonthsValues =
      get12MonthsAverageValues('creditiPendenti');

    indicators.push({
      label: 'CREDITI PENDENTI',
      lastMonthValues: creditiPendentiValues,
      lastMonth: creditiPendentiLastMonth
        ? calculatePercentageChange(
            currentMonthData.creditiPendenti ?? 0,
            creditiPendentiLastMonth as number
          )
        : null,
      ytdValues: creditiPendentiYTDValues,
      ytd: creditiPendentiYTDPreviousAvg
        ? calculatePercentageChange(
            creditiPendentiYTDCurrentAvg,
            creditiPendentiYTDPreviousAvg
          )
        : null,
      last12MonthsValues: creditiPendenti12MonthsValues,
      last12Months: creditiPendenti12MonthsPreviousAvg
        ? calculatePercentageChange(
            creditiPendenti12MonthsCurrentAvg,
            creditiPendenti12MonthsPreviousAvg
          )
        : null,
      unit: '%',
    });
    ...
    const creditiScadutiYTDCurrentAvg =
      creditiScadutiYTD.currentYTD / (currentMonth + 1);
    const creditiScadutiYTDPreviousAvg =
      creditiScadutiYTD.previousYTD / (currentMonth + 1);
    const creditiScaduti12MonthsCurrentAvg =
      creditiScaduti12Months.last12Months / 12;
    const creditiScaduti12MonthsPreviousAvg =
      creditiScaduti12Months.previous12Months / 12;
    ...
    const creditiScaduti12MonthsValues =
      get12MonthsAverageValues('creditiScaduti');

    indicators.push({
      label: 'CREDITI SCADUTI',
      lastMonthValues: creditiScadutiValues,
      lastMonth: creditiScadutiLastMonth
        ? calculatePercentageChange(
            currentMonthData.creditiScaduti ?? 0,
            creditiScadutiLastMonth as number
          )
        : null,
      ytdValues: creditiScadutiYTDValues,
      ytd: creditiScadutiYTDPreviousAvg
        ? calculatePercentageChange(
            creditiScadutiYTDCurrentAvg,
            creditiScadutiYTDPreviousAvg
          )
        : null,
      last12MonthsValues: creditiScaduti12MonthsValues,
      last12Months: creditiScaduti12MonthsPreviousAvg
        ? calculatePercentageChange(
            creditiScaduti12MonthsCurrentAvg,
            creditiScaduti12MonthsPreviousAvg
          )
        : null,
      unit: '%',
    });
    ...
    // DEBITI FORNITORI
    const debitiFornitoriLastMonth =
      getSameMonthPreviousYear('debitiFornitore');
    const debitiFornitoriYTD = getYTDValues('debitiFornitore');
    const debitiFornitori12Months = getLast12MonthsValues('debitiFornitore');

    const debitiFornitoriYTDCurrentAvg =
      debitiFornitoriYTD.currentYTD / (currentMonth + 1);
    const debitiFornitoriYTDPreviousAvg =
      debitiFornitoriYTD.previousYTD / (currentMonth + 1);
    const debitiFornitori12MonthsCurrentAvg =
      debitiFornitori12Months.last12Months / 12;
    const debitiFornitori12MonthsPreviousAvg =
      debitiFornitori12Months.previous12Months / 12;
    ...
    const debitiFornitori12MonthsValues =
      get12MonthsAverageValues('debitiFornitore');

    indicators.push({
      label: 'DEBITI FORNITORI',
      lastMonthValues: debitiFornitoriValues,
      lastMonth: debitiFornitoriLastMonth
        ? calculatePercentageChange(
            currentMonthData.debitiFornitore ?? 0,
            debitiFornitoriLastMonth as number
          )
        : null,
      ytdValues: debitiFornitoriYTDValues,
      ytd: debitiFornitoriYTDPreviousAvg
        ? calculatePercentageChange(
            debitiFornitoriYTDCurrentAvg,
            debitiFornitoriYTDPreviousAvg
          )
        : null,
      last12MonthsValues: debitiFornitori12MonthsValues,
      last12Months: debitiFornitori12MonthsPreviousAvg
        ? calculatePercentageChange(
            debitiFornitori12MonthsCurrentAvg,
            debitiFornitori12MonthsPreviousAvg
          )
        : null,
      unit: '%',
    });
    ...
    const debitiBancariYTDCurrentAvg =
      debitiBancariYTD.currentYTD / (currentMonth + 1);
    const debitiBancariYTDPreviousAvg =
      debitiBancariYTD.previousYTD / (currentMonth + 1);
    const debitiBancari12MonthsCurrentAvg =
      debitiBancari12Months.last12Months / 12;
    const debitiBancari12MonthsPreviousAvg =
      debitiBancari12Months.previous12Months / 12;
    ...
    const debitiBancari12MonthsValues =
      get12MonthsAverageValues('debitiBancari');

    indicators.push({
      label: 'DEBITI BANCARI',
      lastMonthValues: debitiBancariValues,
      lastMonth: debitiBancariLastMonth
        ? calculatePercentageChange(
            currentMonthData.debitiBancari ?? 0,
            debitiBancariLastMonth as number
          )
        : null,
      ytdValues: debitiBancariYTDValues,
      ytd: debitiBancariYTDPreviousAvg
        ? calculatePercentageChange(
            debitiBancariYTDCurrentAvg,
            debitiBancariYTDPreviousAvg
          )
        : null,
      last12MonthsValues: debitiBancari12MonthsValues,
      last12Months: debitiBancari12MonthsPreviousAvg
        ? calculatePercentageChange(
            debitiBancari12MonthsCurrentAvg,
            debitiBancari12MonthsPreviousAvg
          )
        : null,
      unit: '%',
    });
    ...
    const costiFissiYTD = {
      currentYTD: monthlyData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.costiFissi, 0),
      previousYTD: previousYearData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.costiFissi, 0),
    };
    const costiFissi12Months = {
      last12Months: monthlyData.reduce(
        (sum, month) => sum + month.costiFissi,
        0
      ),
      previous12Months: previousYearData.reduce(
        (sum, month) => sum + month.costiFissi,
        0
      ),
    };
    ...
    const costiVariabiliYTD = {
      currentYTD: monthlyData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.costiVariabili, 0),
      previousYTD: previousYearData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.costiVariabili, 0),
    };
    const costiVariabili12Months = {
      last12Months: monthlyData.reduce(
        (sum, month) => sum + month.costiVariabili,
        0
      ),
      previous12Months: previousYearData.reduce(
        (sum, month) => sum + month.costiVariabili,
    ...
    const utileYTD = {
      currentYTD: monthlyData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.utile, 0),
      previousYTD: previousYearData
        .slice(0, currentMonth + 1)
        .reduce((sum, month) => sum + month.utile, 0),
    };
    const utile12Months = {
      ...
      previous12Months: previousYearData.reduce(
        (sum, month) => sum + month.utile,
        0
      ),
    };

    // INCIDENZA COSTI FISSI
    const incidenzaCostiFissiLastMonthCurrent = currentMonthData.incassato
      ? (currentMonthData.costiFissi / currentMonthData.incassato) * 100
      : null;
    const incidenzaCostiFissiLastMonthPrevious = (() => {
      const prevYearData = allData.find(
        d => d.year === currentYear - 1 && d.monthIndex === currentMonth
      );
      return prevYearData && prevYearData.incassato
        ? (prevYearData.costiFissi / prevYearData.incassato) * 100
        : null;
    })();

    const incidenzaCostiFissiYTDCurrent = incassatoYTD.currentYTD
      ? (costiFissiYTD.currentYTD / incassatoYTD.currentYTD) * 100
      : null;
    const incidenzaCostiFissiYTDPrevious = incassatoYTD.previousYTD
      ? (costiFissiYTD.previousYTD / incassatoYTD.previousYTD) * 100
      : null;

    const incidenzaCostiFissi12MonthsCurrent = incassato12Months.last12Months
      ? (costiFissi12Months.last12Months / incassato12Months.last12Months) * 100
      : null;
    const incidenzaCostiFissi12MonthsPrevious =
      incassato12Months.previous12Months
        ? (costiFissi12Months.previous12Months /
            incassato12Months.previous12Months) *
          100
        : null;
    ...
    indicators.push({
      ...
      lastMonthValues: {
        currentValue: incidenzaCostiFissiLastMonthCurrent,
        previousValue: incidenzaCostiFissiLastMonthPrevious,
      },
      lastMonth: incidenzaCostiFissiLastMonthPrevious
        ? calculatePercentageChange(
            incidenzaCostiFissiLastMonthCurrent ?? 0,
            incidenzaCostiFissiLastMonthPrevious
          )
        : null,
      ytdValues: {
        currentValue: incidenzaCostiFissiYTDCurrent,
        previousValue: incidenzaCostiFissiYTDPrevious,
      },
      ytd: incidenzaCostiFissiYTDPrevious
        ? calculatePercentageChange(
            incidenzaCostiFissiYTDCurrent ?? 0,
            incidenzaCostiFissiYTDPrevious
          )
        : null,
      last12MonthsValues: {
        currentValue: incidenzaCostiFissi12MonthsCurrent,
        previousValue: incidenzaCostiFissi12MonthsPrevious,
      },
      last12Months: incidenzaCostiFissi12MonthsPrevious
        ? calculatePercentageChange(
            incidenzaCostiFissi12MonthsCurrent ?? 0,
            incidenzaCostiFissi12MonthsPrevious
          )
        : null,
      unit: '%',
    });
    ...
    const incidenzaCostiVariabiliLastMonthCurrent = currentMonthData.incassato
      ? (currentMonthData.costiVariabili / currentMonthData.incassato) * 100
      : null;
    const incidenzaCostiVariabiliLastMonthPrevious = (() => {
      ...
      return prevYearData && prevYearData.incassato
        ? (prevYearData.costiVariabili / prevYearData.incassato) * 100
        : null;
    })();

    const incidenzaCostiVariabiliYTDCurrent = incassatoYTD.currentYTD
      ? (costiVariabiliYTD.currentYTD / incassatoYTD.currentYTD) * 100
      : null;
    const incidenzaCostiVariabiliYTDPrevious = incassatoYTD.previousYTD
      ? (costiVariabiliYTD.previousYTD / incassatoYTD.previousYTD) * 100
      : null;

    const incidenzaCostiVariabili12MonthsCurrent =
      incassato12Months.last12Months
        ? (costiVariabili12Months.last12Months /
            incassato12Months.last12Months) *
          100
        : null;
    const incidenzaCostiVariabili12MonthsPrevious =
      incassato12Months.previous12Months
        ? (costiVariabili12Months.previous12Months /
            incassato12Months.previous12Months) *
          100
        : null;
    ...
    indicators.push({
      ...
      lastMonthValues: {
        currentValue: incidenzaCostiVariabiliLastMonthCurrent,
        previousValue: incidenzaCostiVariabiliLastMonthPrevious,
      },
      lastMonth: incidenzaCostiVariabiliLastMonthPrevious
        ? calculatePercentageChange(
            incidenzaCostiVariabiliLastMonthCurrent ?? 0,
            incidenzaCostiVariabiliLastMonthPrevious
          )
        : null,
      ytdValues: {
        currentValue: incidenzaCostiVariabiliYTDCurrent,
        previousValue: incidenzaCostiVariabiliYTDPrevious,
      },
      ytd: incidenzaCostiVariabiliYTDPrevious
        ? calculatePercentageChange(
            incidenzaCostiVariabiliYTDCurrent ?? 0,
            incidenzaCostiVariabiliYTDPrevious
          )
        : null,
      last12MonthsValues: {
        currentValue: incidenzaCostiVariabili12MonthsCurrent,
        previousValue: incidenzaCostiVariabili12MonthsPrevious,
      },
      last12Months: incidenzaCostiVariabili12MonthsPrevious
        ? calculatePercentageChange(
            incidenzaCostiVariabili12MonthsCurrent ?? 0,
            incidenzaCostiVariabili12MonthsPrevious
          )
        : null,
      unit: '%',
    });
    ...
    // INCIDENZA UTILE
    const incidenzaUtileLastMonthCurrent = currentMonthData.incassato
      ? (currentMonthData.utile / currentMonthData.incassato) * 100
      : null;
    const incidenzaUtileLastMonthPrevious = (() => {
      ...
      return prevYearData && prevYearData.incassato
        ? (prevYearData.utile / prevYearData.incassato) * 100
        : null;
    })();

    const incidenzaUtileYTDCurrent = incassatoYTD.currentYTD
      ? (utileYTD.currentYTD / incassatoYTD.currentYTD) * 100
      : null;
    const incidenzaUtileYTDPrevious = incassatoYTD.previousYTD
      ? (utileYTD.previousYTD / incassatoYTD.previousYTD) * 100
      : null;

    const incidenzaUtile12MonthsCurrent = incassato12Months.last12Months
      ? (utile12Months.last12Months / incassato12Months.last12Months) * 100
      : null;
    const incidenzaUtile12MonthsPrevious = incassato12Months.previous12Months
      ? (utile12Months.previous12Months / incassato12Months.previous12Months) *
        100
      : null;
    ...
    indicators.push({
      ...
      lastMonthValues: {
        currentValue: incidenzaUtileLastMonthCurrent,
        previousValue: incidenzaUtileLastMonthPrevious,
      },
      lastMonth: incidenzaUtileLastMonthPrevious
        ? calculatePercentageChange(
            incidenzaUtileLastMonthCurrent ?? 0,
            incidenzaUtileLastMonthPrevious
          )
        : null,
      ytdValues: {
        currentValue: incidenzaUtileYTDCurrent,
        previousValue: incidenzaUtileYTDPrevious,
      },
      ytd: incidenzaUtileYTDPrevious
        ? calculatePercentageChange(
            incidenzaUtileYTDCurrent ?? 0,
            incidenzaUtileYTDPrevious
          )
        : null,
      last12MonthsValues: {
        currentValue: incidenzaUtile12MonthsCurrent,
        previousValue: incidenzaUtile12MonthsPrevious,
      },
      last12Months: incidenzaUtile12MonthsPrevious
        ? calculatePercentageChange(
            incidenzaUtile12MonthsCurrent ?? 0,
            incidenzaUtile12MonthsPrevious
          )
        : null,
      unit: '%',
    });
    ...
    const previsionaleConsuntivo = [
      ...
      },
      {
        ...
        previsionale: getCostiFissiTotal(
          causaliCatalog,
          planYear,
          getPlanPreventivoValue,
          currentMonthData.year,
      ...
      },
      {
        ...
        previsionale: getCostiVariabiliTotal(
          causaliCatalog,
          planYear,
          getPlanPreventivoValue,
          currentMonthData.year,
      ...
      },
      {
        ...
        previsionale: calculateUtileFromMacroTotals(
          causaliCatalog,
          planYear,
          getPlanPreventivoValue,
          currentMonthData.year,
    ...
    const availableMonths = allData
      ...
      .map(d => ({
        ...
        label: format(new Date(d.year, d.monthIndex, 1), 'MMMM yyyy', {
          locale: it,
        }),
    ...
    return {
      indicators,
      previsionaleConsuntivo,
      lastCompiledMonth: format(
        new Date(lastCompiledMonth.year, lastCompiledMonth.monthIndex, 1),
        'MMMM yyyy',
        { locale: it }
      ),
      currentMonthLabel: format(
        new Date(currentMonthData.year, currentMonthData.monthIndex, 1),
        'MMMM yyyy',
        { locale: it }
      ),
      currentYear,
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              <span className="font-semibold text-blue-600">
                {analysisData.currentMonthLabel}
              </span>
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {analysisData.indicators.length > 0
          ? analysisData.indicators.map(indicator => {
              ...
              const formatFunc = isIncidenza
                ? formatIncidenzaPercentage
                : formatPercentage;
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-3 border border-blue-200">
                      ...
                      <div className="flex items-center justify-between">
                          ...
                          <div className="space-y-1">
                            <div className="text-sm text-gray-700">
                              ...
                              <span className="font-semibold">
                                {indicator.lastMonthValues.currentValue !== null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.lastMonthValues.currentValue
                                      )
                                    : formatCurrency(
                                        indicator.lastMonthValues.currentValue
                                      )
                            ...
                            <div className="text-sm text-gray-500">
                              ...
                              <span className="font-medium">
                                {indicator.lastMonthValues.previousValue !==
                                null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.lastMonthValues.previousValue
                        ...
                        <div
                          className={`px-3 py-2 rounded-full text-lg font-bold ${getChangeColor(indicator.lastMonth)} flex items-center justify-center min-w-[60px]`}
                        >
                    ...
                    <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-lg p-3 border border-emerald-200">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="space-y-1">
                            <div className="text-sm text-gray-700">
                              2025:{' '}
                              <span className="font-semibold">
                                {indicator.ytdValues.currentValue !== null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.ytdValues.currentValue
                                      )
                                    : formatCurrency(
                                        indicator.ytdValues.currentValue
                                      )
                            ...
                            <div className="text-sm text-gray-500">
                              2024:{' '}
                              <span className="font-medium">
                                {indicator.ytdValues.previousValue !== null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.ytdValues.previousValue
                                      )
                                    : formatCurrency(
                                        indicator.ytdValues.previousValue
                                      )
                        ...
                        <div
                          className={`px-3 py-2 rounded-full text-lg font-bold ${getChangeColor(indicator.ytd)} flex items-center justify-center min-w-[60px]`}
                        >
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-3 border border-purple-200">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="space-y-1">
                            <div className="text-sm text-gray-700">
                              {analysisData.currentYear}:{' '}
                              <span className="font-semibold">
                                {indicator.last12MonthsValues.currentValue !==
                                null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.last12MonthsValues
                                          .currentValue
                                      )
                                    : formatCurrency(
                                        indicator.last12MonthsValues
                            ...
                            <div className="text-sm text-gray-500">
                              {analysisData.currentYear - 1}:{' '}
                              <span className="font-medium">
                                {indicator.last12MonthsValues.previousValue !==
                                null
                                  ? isIncidenza
                                    ? formatIncidenzaPercentage(
                                        indicator.last12MonthsValues
                        ...
                        <div
                          className={`px-3 py-2 rounded-full text-lg font-bold ${getChangeColor(indicator.last12Months)} flex items-center justify-center min-w-[60px]`}
                        >
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="px-3 py-2 rounded-full text-lg font-bold text-gray-500 flex items-center justify-center min-w-[60px]">
                        -
                      </div>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {analysisData.previsionaleConsuntivo.length > 0
            ? analysisData.previsionaleConsuntivo.map(item => {
                const variazione =
                  item.consuntivo && item.previsionale
                    ? ((item.consuntivo - item.previsionale) /
                        item.previsionale) *
                      100
                    : null;
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-lg p-3 border border-emerald-200 text-center">
                        ...
                        <p
                          className={`text-base font-semibold mt-1 ${getChangeColor(variazione)}`}
                        >
