...
export const FinancialOverview: React.FC<FinancialOverviewProps> = ({
  ...
  const overviewTotals = useMemo(() => {
    ...
    const calculateYearTotals = (year: number, maxMonths: number = 12) => {
      ...
      const costiVariabili = Array.from(
        { length: maxMonths },
        (_, monthIndex) => monthIndex
      ).reduce(
        (acc, monthIndex) =>
      ...
      const fatturato = Array.from(
        { length: maxMonths },
        (_, monthIndex) => monthIndex
      ).reduce((acc, monthIndex) => {
    ...
    if (isCurrentYear) {
      ...
      prevYearYTDTotals = calculateYearTotals(
        selectedYear - 1,
        monthsToInclude
      );
    }
    ...
    let fatturatoIncrement,
      incassatoIncrement,
      costiFissiIncrement,
      costiVariabiliIncrement,
      utileIncrement;
    ...
    if (isCurrentYear) {
      ...
      fatturatoIncrement =
        prevYearYTDTotals.fatturato === 0
          ? null
          : calculateIncrement(
              currentYearYTDTotals.fatturato,
              prevYearYTDTotals.fatturato
            );
      incassatoIncrement =
        prevYearYTDTotals.incassato === 0
          ? null
          : calculateIncrement(
              currentYearYTDTotals.incassato,
              prevYearYTDTotals.incassato
            );
      costiFissiIncrement =
        prevYearYTDTotals.costiFissi === 0
          ? null
          : calculateIncrement(
              currentYearYTDTotals.costiFissi,
              prevYearYTDTotals.costiFissi
            );
      costiVariabiliIncrement =
        prevYearYTDTotals.costiVariabili === 0
          ? null
          : calculateIncrement(
              currentYearYTDTotals.costiVariabili,
              prevYearYTDTotals.costiVariabili
            );
      utileIncrement =
        prevYearYTDTotals.utile === 0
          ? null
          : calculateIncrement(
              currentYearYTDTotals.utile,
              prevYearYTDTotals.utile
            );
    } else {
      // For other years, use full year comparison
      // Don't show increment if previous year is zero (first year with data)
      fatturatoIncrement =
        prevYear1Totals.fatturato === 0
          ? null
          : calculateIncrement(
              currentYearTotals.fatturato,
              prevYear1Totals.fatturato
            );
      incassatoIncrement =
        prevYear1Totals.incassato === 0
          ? null
          : calculateIncrement(
              currentYearTotals.incassato,
              prevYear1Totals.incassato
            );
      costiFissiIncrement =
        prevYear1Totals.costiFissi === 0
          ? null
          : calculateIncrement(
              currentYearTotals.costiFissi,
              prevYear1Totals.costiFissi
            );
      costiVariabiliIncrement =
        prevYear1Totals.costiVariabili === 0
          ? null
          : calculateIncrement(
              currentYearTotals.costiVariabili,
              prevYear1Totals.costiVariabili
            );
      utileIncrement =
        prevYear1Totals.utile === 0
          ? null
          : calculateIncrement(currentYearTotals.utile, prevYear1Totals.utile);
    }
  ...
  const overviewChartData = useMemo(() => {
    ...
    const totalCostiVariabili = costiVariabili.reduce(
      (acc, value) => acc + value,
      0
    );
    ...
    return MONTH_SHORT.map((label, index) => ({
      ...
      utile: calculateUtileFromMacroTotals(
        causaliCatalog,
        planYear,
        getPlanConsuntivoValue,
        selectedYear,
          ...
          <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear3.fatturato)}
                  </span>
                  {(() => {
            ...
            {overviewTotals.prevYear2.fatturato > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear2.fatturato)}
                  </span>
                  {(() => {
                    // Show increment of 2023 vs 2022
                    const increment = calculateIncrement(
                      overviewTotals.prevYear2.fatturato,
                      overviewTotals.prevYear3.fatturato
                    );
                    return (
                      increment !== null && (
                        <span
            ...
            {overviewTotals.prevYear1.fatturato > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear1.fatturato)}
                  </span>
                  {(() => {
                    // Show increment of 2024 vs 2023
                    const increment = calculateIncrement(
                      overviewTotals.prevYear1.fatturato,
                      overviewTotals.prevYear2.fatturato
                    );
                    return (
                      increment !== null && (
            ...
            <div className="flex justify-between items-center border-t pt-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg font-semibold text-blue-700">
                  {formatCurrencyValue(
                    isCurrentYear
                      ? overviewTotals.currentYearYTDTotals?.fatturato ||
                          overviewTotals.currentYear.fatturato
                      : overviewTotals.currentYear.fatturato
                  )}
                </span>
                {overviewTotals.increments.fatturato !== null &&
                  isCurrentYear && (
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    >
                      {overviewTotals.increments.fatturato >= 0 ? '+' : ''}
                      {overviewTotals.increments.fatturato.toFixed(1)}%
          ...
          <div className="space-y-2">
            {overviewTotals.prevYear3.incassato > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear3.incassato)}
                  </span>
                  {(() => {
                    // Don't show increment for 2022 - it's the first year with data
                    return null;
            ...
            {overviewTotals.prevYear2.incassato > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear2.incassato)}
                  </span>
                  {(() => {
            ...
            {overviewTotals.prevYear1.incassato > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear1.incassato)}
                  </span>
                  {(() => {
                    // Show increment of 2024 vs 2023
                    const increment = calculateIncrement(
                      overviewTotals.prevYear1.incassato,
                      overviewTotals.prevYear2.incassato
                    );
                    return (
                      increment !== null && (
                        <span
                  ...
                  {formatCurrencyValue(
                    isCurrentYear
                      ? overviewTotals.currentYearYTDTotals?.incassato ||
                          overviewTotals.currentYear.incassato
                      : overviewTotals.currentYear.incassato
                  )}
                </span>
                {overviewTotals.increments.incassato !== null &&
                  isCurrentYear && (
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    >
                      {overviewTotals.increments.incassato >= 0 ? '+' : ''}
                      {overviewTotals.increments.incassato.toFixed(1)}%
                      {isCurrentYear && (
                        <span className="ml-1 text-xs opacity-75">YTD</span>
                      )}
                    </span>
          ...
          <div className="space-y-2">
            {overviewTotals.prevYear3.costiFissi > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear3.costiFissi)}
                  </span>
                  {(() => {
                    // Don't show increment for 2022 - it's the first year with data
                    return null;
            ...
            {overviewTotals.prevYear2.costiFissi > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear2.costiFissi)}
                  </span>
                  {(() => {
            ...
            {overviewTotals.prevYear1.costiFissi > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear1.costiFissi)}
                  </span>
                  {(() => {
                    // Show increment of 2024 vs 2023
                    const increment = calculateIncrement(
                      overviewTotals.prevYear1.costiFissi,
                      overviewTotals.prevYear2.costiFissi
                    );
                    return (
                      increment !== null && (
                        <span
                  ...
                  {formatCurrencyValue(
                    isCurrentYear
                      ? overviewTotals.currentYearYTDTotals?.costiFissi ||
                          overviewTotals.currentYear.costiFissi
                      : overviewTotals.currentYear.costiFissi
                  )}
                </span>
                {overviewTotals.increments.costiFissi !== null &&
                  isCurrentYear && (
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    >
                      {overviewTotals.increments.costiFissi >= 0 ? '+' : ''}
                      {overviewTotals.increments.costiFissi.toFixed(1)}%
                      {isCurrentYear && (
                        <span className="ml-1 text-xs opacity-75">YTD</span>
                      )}
                    </span>
            ...
            {overviewTotals.prevYear3.costiVariabili > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(
                      overviewTotals.prevYear3.costiVariabili
                    )}
                  </span>
                  {(() => {
                    // Don't show increment for 2022 - it's the first year with data
            ...
            {overviewTotals.prevYear2.costiVariabili > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(
                      overviewTotals.prevYear2.costiVariabili
                    )}
                  </span>
                  {(() => {
            ...
            {overviewTotals.prevYear1.costiVariabili > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(
                      overviewTotals.prevYear1.costiVariabili
                    )}
                  </span>
                  {(() => {
                    // Show increment of 2024 vs 2023
                  ...
                  {formatCurrencyValue(
                    isCurrentYear
                      ? overviewTotals.currentYearYTDTotals?.costiVariabili ||
                          overviewTotals.currentYear.costiVariabili
                      : overviewTotals.currentYear.costiVariabili
                  )}
                </span>
                {overviewTotals.increments.costiVariabili !== null &&
                  isCurrentYear && (
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    >
                      {overviewTotals.increments.costiVariabili >= 0 ? '+' : ''}
                      {overviewTotals.increments.costiVariabili.toFixed(1)}%
                      {isCurrentYear && (
                        <span className="ml-1 text-xs opacity-75">YTD</span>
                      )}
                    </span>
          ...
          <div className="space-y-2">
            {overviewTotals.prevYear3.utile > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear3.utile)}
                  </span>
                  {(() => {
                    // Don't show increment for 2022 - it's the first year with data
                    return null;
            ...
            {overviewTotals.prevYear2.utile > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear2.utile)}
                  </span>
                  {(() => {
            ...
            {overviewTotals.prevYear1.utile > 0 && (
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-700">
                    {formatCurrencyValue(overviewTotals.prevYear1.utile)}
                  </span>
                  {(() => {
                    // Show increment of 2024 vs 2023
                    const increment = calculateIncrement(
                      overviewTotals.prevYear1.utile,
                      overviewTotals.prevYear2.utile
                    );
                    return (
                      increment !== null && (
                        <span
            ...
            <div className="flex justify-between items-center border-t pt-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg font-semibold text-emerald-700">
                  {formatCurrencyValue(
                    isCurrentYear
                      ? overviewTotals.currentYearYTDTotals?.utile ||
                          overviewTotals.currentYear.utile
                      : overviewTotals.currentYear.utile
                  )}
                </span>
                {overviewTotals.increments.utile !== null && isCurrentYear && (
                  ...
                  >
                    {overviewTotals.increments.utile >= 0 ? '+' : ''}
                    {overviewTotals.increments.utile.toFixed(1)}%
                    {isCurrentYear && (
                      <span className="ml-1 text-xs opacity-75">YTD</span>
                    )}
                  </span>
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={overviewChartData}>
            ...
            />
            <Bar dataKey="utile" name="Utile Mensile" radius={[4, 4, 0, 0]}>
