  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 bg-primary-600 hover:bg-primary-700 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-200 z-50 flex items-center gap-2"
      ...
      >
        ...
        <span className="hidden sm:inline font-medium">Assistente</span>
      </button>
    );
  }
    ...
    <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 border border-gray-200">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-lg">Assistente Esperto</h3>
            <p className="text-xs text-primary-100">RistoManager Pro</p>
          </div>
        </div>
        <button
